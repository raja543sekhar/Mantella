...
If you need to support other browsers or older NodeJS versions, I can recommend [Babel](https://babeljs.io) to compile a suitable browser version according to your own requirements.
