...
> If you need to support other browsers or NodeJS versions, I can recommend [Babel](https://babeljs.io) to compile a suitable browser/NodeJS version according to your own requirements.
